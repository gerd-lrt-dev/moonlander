...
public:
     ...
     */
    void drawCockpit(double t, Vector3 B_position, Vector3 B_velocity, Vector3 B_acceleration, double hMax, double thrust, double targetThrust, double fuelConsumption, double fuelMass, bool integrity);
