...
Q_CONSTINIT const QMetaObject Homepage::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8HomepageE_t,
        ...
        // method 'requestStartOfSimulation'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'sendJsonToWorker'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Homepage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &Homepage::requestStartOfSimulation; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (Homepage::*)(const QString & );
            if (_q_method_type _q_method = &Homepage::sendJsonToWorker; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
